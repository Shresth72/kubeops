...
type FakeKlusters struct {
	Fake *FakeShresth72V1alpha1
	ns   string
}

var klustersResource = schema.GroupVersionResource{
	Group:    "shresth72.dev",
	Version:  "v1alpha1",
	Resource: "klusters",
}

var klustersKind = schema.GroupVersionKind{
	Group:   "shresth72.dev",
	Version: "v1alpha1",
	Kind:    "Kluster",
}
...
func (c *FakeKlusters) List(
	ctx context.Context,
	opts v1.ListOptions,
) (result *v1alpha1.KlusterList, err error) {
	obj, err := c.Fake.
		Invokes(
			testing.NewListAction(klustersResource, klustersKind, c.ns, opts),
			&v1alpha1.KlusterList{},
		)
...
func (c *FakeKlusters) UpdateStatus(
	ctx context.Context,
	kluster *v1alpha1.Kluster,
	opts v1.UpdateOptions,
	...
	obj, err := c.Fake.
		Invokes(
			testing.NewUpdateSubresourceAction(klustersResource, "status", c.ns, kluster),
			&v1alpha1.Kluster{},
		)
	if obj == nil {
		return nil, err
...
func (c *FakeKlusters) DeleteCollection(
	ctx context.Context,
