...
import (
	...
	scheme "github.com/shresth72/kluster/pkg/client/clientset/versioned/scheme"
...
func newKlusters(c *Shresth72V1alpha1Client, namespace string) *klusters {
	return &klusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *klusters) DeleteCollection(
	ctx context.Context,
