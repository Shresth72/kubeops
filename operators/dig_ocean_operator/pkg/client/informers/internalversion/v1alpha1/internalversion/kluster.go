...
import (
	...
	internalinterfaces "github.com/shresth72/kluster/pkg/client/informers/internalversion/internalinterfaces"
	internalversion "github.com/shresth72/kluster/pkg/client/listers/v1alpha1/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Shresth72().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Shresth72().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&v1alpha1.Kluster{},
		resyncPeriod,
